...
/*	This funtion joins threads and does	clean-up
	in case of an error during creation of threads.
**	Second parameter is a flag for indicating
	if create_thread() fails at array of philo threads
	or after single monitor thread.
**	thread_array_flag = 1 >> Function joins with created
